...
const Home: React.FC = () => {
  ...
  return (
    <Layout>
      {/* Hero Section - Patagónico */}
      <section className="relative bg-gradient-to-br from-stone-800 via-stone-700 to-amber-900 text-amber-50 py-16 md:py-24 overflow-hidden">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative">
                <img 
                  ...
                  className="rounded-xl shadow-2xl max-w-full h-auto animate-fade-in border-4 border-amber-600"
                  style={{ maxHeight: '500px' }}
                />
                {/* Overlay decorativo */}
                <div className="absolute -bottom-4 -right-4 bg-amber-600 text-stone-900 p-3 rounded-lg shadow-lg">
      ...
      {/* Features Section - Estilo rústico */}
      <section className="py-16 bg-gradient-to-b from-stone-100 to-amber-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Trees className="h-12 w-12 text-amber-600 mx-auto mb-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-l-4 border-amber-600">
              <div className="rounded-full bg-amber-100 p-4 w-16 h-16 flex items-center justify-center mb-6 mx-auto">
      ...
      {/* How it Works Section - Temática patagónica */}
      <section className="py-16 bg-stone-800 text-amber-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-stone-700 p-8 rounded-xl border-2 border-amber-600">
              <div className="bg-amber-600 text-stone-900 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6 text-2xl font-bold shadow-lg">
                1
              </div>
              <h3 className="text-xl font-bold mb-4 text-amber-100">Buscá tu viaje</h3>
            ...
            <div className="text-center bg-stone-700 p-8 rounded-xl border-2 border-amber-600">
              ...
              <h3 className="text-xl font-bold mb-4 text-amber-100">Reservá tu lugar</h3>
              <p className="text-amber-200 leading-relaxed">
            ...
            <div className="text-center bg-stone-700 p-8 rounded-xl border-2 border-amber-600">
              ...
              <h3 className="text-xl font-bold mb-4 text-amber-100">¡Disfrutá el viaje!</h3>
              <p className="text-amber-200 leading-relaxed">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 text-stone-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button 
              ...
              className="bg-stone-800 hover:bg-stone-700 text-amber-100 border-stone-700"
            >
              Publicar un Viaje
            </Button>
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-stone-800 text-stone-800 hover:bg-stone-800 hover:text-amber-100"
      ...
      {/* Testimonials Section - Estilo patagónico */}
      <section className="py-16 bg-gradient-to-b from-stone-100 to-amber-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border-l-4 border-amber-600">
