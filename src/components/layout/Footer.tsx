...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-stone-800 via-stone-700 to-stone-800 text-emerald-50 py-12 border-t-4 border-emerald-500">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex space-x-4 mt-4">
                  <a href="#" className="text-emerald-200 hover:text-emerald-400 transition-colors p-2 bg-stone-700 rounded-full">
